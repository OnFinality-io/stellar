{{- define "mx.common.labels" }}
generator: mx-kube-worker
chart: {{ .Chart.Name }}
...
# TODO - move to correct conditions
- name: NODE_SEED
  value: {{ .Values.nodeSeed }}
- name: NODE_HOME_DOMAIN
  value: {{ .Values.NODE_HOME_DOMAIN }}
- name: STELLAR_CORE_S3_GET
  value: {{ .Values.historyGet }}
- name: STELLAR_CORE_S3_PUT
  value: {{ .Values.historyPut }}
